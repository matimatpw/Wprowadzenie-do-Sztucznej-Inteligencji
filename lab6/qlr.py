...
def main():
    for learning_rate in learning_rates:
        for temperature in temperatures:
            ...
            avg_reward_epsilon, episode_rewards_greedy, episode_steps_greedy = evaluate_policy(q_table_epsilon, env, epsilon=epsilon_value, num_episodes=evaluate_episodes, exploration_strategy='epsilon-greedy', max_steps=steps_limit)
            ...
            avg_reward_boltzmann, episode_rewards_boltz, episode_steps_bolts = evaluate_policy(q_table_boltzmann, env, temperature=temperature, num_episodes=evaluate_episodes, exploration_strategy='boltzmann', max_steps=steps_limit)
